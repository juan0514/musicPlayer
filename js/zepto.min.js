  ...
  var e = function () {
    function $(t) {
      ...
      var n,
          i,
          o,
          r = [];if (z(t)) for (i = 0; i < t.length; i++) n = e(t[i], i), null != n && r.push(n);else for (o in t) n = e(t[o], o), null != n && r.push(n);return H(r);
    }, r.each = function (t, e) {
      var n, r;if (z(t)) {
      ...
      S["[object " + e + "]"] = e.toLowerCase();
        ...
        var n = [],
          ...
          for (; o && !(i ? i.indexOf(o) >= 0 : N.matches(o, t));) o = o !== e && !M(o) && o.parentNode;o && n.indexOf(o) < 0 && n.push(o);
        }), r(n);
      }, parents: function (t) {
        ...
        if (this[0]) {
          r(this[0]).before(t = r(t));for (var e; (e = t.children()).length;) t = e.first();r(t).append(this);
        }return this;
        ...
        return this.map(function () {
          for (var t = this.offsetParent || f.body; t && !g.test(t.nodeName) && "static" == r(t).css("position");) t = t.offsetParent;return t;
        });
    ...
    function h(t) {
      ...
      var c = h(t),
        ...
        if ("ready" == n) return e(document).ready(i);var a = d(n);a.fn = i, a.sel = s, a.e in l && (i = function (t) {
      ...
      s(t) || (e = t, t = e.type);var n = document.createEvent(u[t] || "Events"),
          r = !0;if (e) for (var i in e) "bubbles" == i ? r = !!e[i] : n[i] = e[i];return n.initEvent(t, r, !0), T(n);
    };
  }(e), function (e) {
    function p(t, n, r) {
